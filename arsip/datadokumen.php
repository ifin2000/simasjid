<div class="panel panel-info">
             ...
             <input type="hidden" name="cabang" id="cabang" value="<?php echo $cbg;?>">
                <h3 class="panel-title">Data Dokumen Yayasan</h3>
            ...
            <div class="form-group">
                <div class="col-md-12">
                <br>&nbsp;<br>&nbsp;<a class="btn btn-warning col-md-3" href="?pages=adddokumen" <?php if($div=='administrator'){ echo ''; } else { echo 'disabled="true"'; } ?>><i class="fa fa-pencil"></i> Entry Dokumen Baru </a><br>&nbsp;<br>&nbsp;
                </div>
            </div>
            ...
            <div class="form-group">
            	...
            	<div class="table-responsive">
                    <table class="table datatable table-bordered table-striped" id="tabeldokumen">
                        <thead>
                            <tr class="success">
    ...
    <script type="text/javascript" src="incl/js/arsip/datdokumen.js"></script>