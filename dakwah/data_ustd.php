<div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">Data Ustadz (Pengisi Kajian Rutin)</h3>
            ...
            <div class="form-group">
                <div class="col-md-12">
                <br>&nbsp;<br>&nbsp;<a class="btn btn-warning col-md-3" href="?pages=addustadz" <?php if($div=='administrator'){ echo ''; } else { echo 'disabled="true"'; } ?>><i class="fa fa-pencil"></i> Entry Ustadz Baru </a><br>&nbsp;<br>&nbsp;
                </div>
            </div>
            ...
            <div class="form-group">
            	...
            	<div class="table-responsive">
                    <table class="table datatable table-bordered table-striped" id="tabelustadz">
                        <thead>
                            <tr class="success">
