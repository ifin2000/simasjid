		<div class="panel panel-info">
             ...
             <input type="hidden" name="cabang" id="cabang" value="<?php echo $cbg;?>">
                <h3 class="panel-title">Jadwal Khotib Jumat</h3>
            ...
            <div class="form-group">
                <div class="col-md-12">
                <br>&nbsp;<br>&nbsp;<a class="btn btn-warning col-md-3" href="?pages=addkhotib" <?php if($div=='administrator'){ echo ''; } else { echo 'disabled="true"'; } ?>><i class="fa fa-pencil"></i> Entry Jadwal Baru </a><br>&nbsp;<br>&nbsp;
                </div>
            </div>
            ...
            <div class="form-group">
            	...
            	<div class="table-responsive">
                    <table class="table datatable table-bordered table-striped" id="tabelkhotib">
                        <thead>
                            <tr class="success">
                                <th style="width:5%">No.</th>
								<th style="width:15%">Tgl</th>
								<th style="width:30%">Nama Khotib</th>
								<th style="width:25%">Bilal</th>
								<th style="width:25%">Muadzin</th>
