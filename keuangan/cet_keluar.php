...
?>
    ...
    <div id="table_data" class="col-md-10 container">
      <div id='dvData' class="table-responsive">
        <br>
        <h3 class='control-label text-center'>LAPORAN PENGELUARAN PER PERIODE : <?php echo $tg1 ?> s/d <?php echo $tg2 ?></h3>
        <br>
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
              ...
              if ($var3 != 'semua') {
                $query = "select kode,tgl,nama,uraian,nilai from dat_trans where jenis='Pengeluaran' and nama='$var3' and tgl between '$var1' and '$var2' order by tgl";
              } else {
                $query = "select kode,tgl,nama,uraian,nilai from dat_trans where jenis='Pengeluaran' and tgl between '$var1' and '$var2' order by tgl";
              }
              ...
              if ($hal>1) {
                for ($j=1; $j<=$hal+1; $j++) {
                    if ($j==$n) { echo "<b>$j</b>"; }
                    else { echo " <a href=\"cet_keluar.php?n=$j&var1=$var1&var2=$var2&var3=$var3\" class=\"mainmenu\">$j</a> "; }
                  }
              }
              echo "</p>";
            ?>
