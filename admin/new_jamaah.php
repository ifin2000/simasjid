...
if (($nama=='') OR ($_POST['rt']=='') OR ($telp=='')){ 
    ...
    $resukt = mysqli_query($db_link,"insert into warga_muslim (id,nama_lengkap,tgl_lahir,gender,agama,alamat,rt,rw,kelurahan,nohp) values('0','$nama','$tgllahir','$gender','Islam','$alamat','$wrgrt','','Situsari','$telp')");
    if ($resukt) {
